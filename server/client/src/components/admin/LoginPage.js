      ...
      <img src = 'https://www.durhamcool.com/wp-content/uploads/2018/04/image-5.jpeg' className='bg'/>
       ...
       <div className='container text-center'>
          ...
          <div className='login-box'>
              <input style={{color: '#fff'}} className='col-md-6 login-form username' placeholder= "Username" value={username} onChange={handleUsernameChange}></input>
              <br />
              <input style={{color: '#fff'}} className='col-md-6 login-form password' placeholder='Password' type='password' value={password} onChange={handlePasswordChange}></input>
          </div>
          <br/>
